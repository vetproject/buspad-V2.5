...
public class SongActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        listView.setOnItemClickListener((parent, view, position, id) -> {
            ...
            String videoPath = "http://192.168.8.131/busPad/movies/Song/" + videoName;

            // Pass the HTTP URL to the VideoPlayerActivity
            Intent intent = new Intent(SongActivity.this, VideoPlayerActivity.class);
    ...
    private class FetchVideosTask extends AsyncTask<Void, Void, ArrayList<String>> {
        ...
        protected ArrayList<String> doInBackground(Void... voids) {
            ...
            try {
                ...
                Vector<ChannelSftp.LsEntry> files = sftp.ls("/var/www/html/busPad/movies/Song");
        ...
        protected void onPostExecute(ArrayList<String> result) {
            if (result.isEmpty()) {
                Toast.makeText(SongActivity.this, "Failed to fetch videos", Toast.LENGTH_SHORT).show();
            } else {
                videoList = result;
                adapter = new ArrayAdapter<>(SongActivity.this, android.R.layout.simple_list_item_1, videoList);
