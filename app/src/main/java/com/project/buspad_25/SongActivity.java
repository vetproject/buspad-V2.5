...
public class SongActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        backBtn.setOnClickListener(v -> {
            Intent intent = new Intent(SongActivity.this, VideosActivity.class);
        ...
        protected void onPostExecute(ArrayList<String> result) {
            if (result.isEmpty()) {
                ...
                for (String videoName : result) {
                    String videoPath = "http://192.168.1.222/busPad/movies/Song/" + videoName;
                    videoList.add(new Video(videoName, videoPath));
                }
                videoAdapter = new VideoAdapter(SongActivity.this, videoList);
