...
public class KhmercomedyActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        listView.setOnItemClickListener((parent, view, position, id) -> {
            ...
            String videoPath = "http://192.168.8.131/busPad/movies/Khmer Comedy/" + videoName;

            // Pass the HTTP URL to the VideoPlayerActivity
            Intent intent = new Intent(KhmercomedyActivity.this, VideoPlayerActivity.class);
    ...
    private class FetchVideosTask extends AsyncTask<Void, Void, ArrayList<String>> {
        ...
        protected ArrayList<String> doInBackground(Void... voids) {
            ...
            try {
                ...
                Vector<ChannelSftp.LsEntry> files = sftp.ls("/var/www/html/busPad/movies/Khmer Comedy");
        ...
        protected void onPostExecute(ArrayList<String> result) {
            if (result.isEmpty()) {
                ...
                videoList = result;
                adapter = new ArrayAdapter<>(KhmercomedyActivity.this, android.R.layout.simple_list_item_1, videoList);
